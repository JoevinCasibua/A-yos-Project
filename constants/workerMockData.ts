...
export const workerReviews: WorkerReview[] = [
  ...
  },
  {
    ...
    rating: 3,
    date: '1 month ago',
    comment: 'Decent work on the wiring but left a bit of a mess behind. Had to clean up after. Communication was good though.',
    serviceType: 'Electrical Wiring',
  },
  {
    id: '6',
    author: 'Jessica Lee',
    avatarUri: 'https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=100',
    rating: 2,
    date: '1 month ago',
    comment: 'The AC is working again but it took three visits to get it right. Not happy with the inconvenience and the extra time spent.',
    serviceType: 'AC Repair',
  },
  {
    id: '7',
    author: 'Robert Chen',
    avatarUri: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=100',
    rating: 1,
    date: '2 months ago',
    comment: 'Very disappointed. The paint job was uneven and some areas were missed entirely. Had to hire someone else to fix it.',
    serviceType: 'Painting',
  },
  {
    id: '8',
    author: 'Amanda Foster',
    avatarUri: 'https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg?auto=compress&cs=tinysrgb&w=100',
    rating: 5,
    date: '3 days ago',
    comment: 'Amazing work! The furniture was assembled perfectly and quickly. Very meticulous and careful with my floors and walls.',
  ...
  },
  {
    ...
    rating: 4,
    date: '1 week ago',
    comment: 'The garden looks great. Trimmed the hedges neatly and cleaned up all the clippings. Would have liked more attention to the flower beds.',
    serviceType: 'Garden Maintenance',
  },
  {
    id: '10',
    author: 'Priya Patel',
    avatarUri: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=100',
    rating: 5,
    date: '2 weeks ago',
    comment: 'Pool has never looked cleaner! Came early, worked efficiently, and left the area spotless. Highly recommend for pool maintenance.',
...
export const workerJobs: JobOpportunity[] = [
  ...
  },
  {
    ...
    location: '45 P. Burgos Street, Makati',
    distance: '1.2 mi',
    offeredPrice: '₱4,500',
    urgency: 'normal',
  ...
  },
  {
    ...
    location: '88 Katipunan Avenue, Quezon City',
    distance: '2.1 mi',
    offeredPrice: '₱850',
    urgency: 'normal',
  ...
  },
  {
    ...
    location: '15 A. Mabini Street, Mandaluyong',
    distance: '2.8 mi',
    offeredPrice: '₱600',
    urgency: 'urgent',
  ...
  },
  {
    ...
    location: '76 Ortigas Avenue, Pasig',
    distance: '1.0 mi',
    offeredPrice: '₱800',
    urgency: 'normal',
  ...
  },
  {
    ...
    location: '23 Shaw Boulevard, Mandaluyong',
    distance: '3.2 mi',
    offeredPrice: '₱800',
    urgency: 'normal',
...
export const workerBookings: WorkerBooking[] = [
  ...
  },
  {
    ...
    date: 'Today, Jul 14',
    time: '4:30 PM',
    address: '45 P. Burgos Street, Makati',
    lat: 14.5547,
    lng: 121.0244,
    status: 'in_progress',
    price: '₱750',
  ...
  },
  {
    ...
    time: '9:00 AM',
    address: '88 Katipunan Avenue, Quezon City',
    lat: 14.5719,
    lng: 121.0516,
    status: 'en_route',
    price: '₱4,500',
  ...
  },
  {
    ...
    date: 'Jul 10, 2024',
    time: '3:00 PM',
    address: '15 A. Mabini Street, Mandaluyong',
    lat: 14.5387,
    lng: 121.0627,
  ...
  },
  {
    ...
    date: 'Today, Jul 14',
    time: '5:00 PM',
    address: '76 Ortigas Avenue, Pasig',
    lat: 14.5826,
    lng: 120.9787,
    status: 'accepted',
    price: '₱800',
  ...
  },
  {
    ...
    date: 'Jul 8, 2024',
    time: '10:00 AM',
    address: '23 Shaw Boulevard, Mandaluyong',
    lat: 14.6107,
    lng: 121.0359,
    status: 'cancelled',
    price: '₱800',
