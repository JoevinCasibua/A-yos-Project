...
export interface WorkerChatItem {
  id: string;
  name: string;
  lastMessage: string;
  time: string;
...
interface WorkerMessagesListProps {
  chats: WorkerChatItem[];
  emptyDescription: string;
}

export function WorkerMessagesList({ chats, emptyDescription }: WorkerMessagesListProps) {
