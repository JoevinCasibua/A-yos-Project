...
const generateReviews = (count) => {
  const reviewsText = [
    ...
    "The worker arrived late but did a decent job.",
    "Completely unsatisfied. The issue was not fixed.",
    "Very professional and clean work. Will book again.",
    "Average experience. Pricing was a bit high.",
    "Excellent communication and fast resolution.",
    "The worker was rude and left a mess.",
    "Amazing! Best service I've ever used on this app."
  ];
  const statuses = ['Published', 'Hidden', 'Flagged'];
  
  return Array.from({ length: count }, (_, i) => {
    const rating = Math.floor(Math.random() * 5) + 1;
    let reviewText = reviewsText[Math.floor(Math.random() * reviewsText.length)];
    ...
    return {
      ...
      service: ['Plumbing', 'Cleaning', 'Electrical'][Math.floor(Math.random() * 3)],
      rating: rating,
      comment: reviewText,
...
const mockReviews = generateReviews(50);
