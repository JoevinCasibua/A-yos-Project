...
import { ArrowLeft, CreditCard, Wallet, Plus, ChevronRight } from 'lucide-react-native';
  ...
  return (
    <Screen safeArea backgroundColor={theme.colors.background}>
      <View style={styles.header}>
        ...
        <Text style={[theme.typography.h4, { color: theme.colors.textPrimary }]}>Payment Methods</Text>
